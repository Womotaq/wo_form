...
@notSerializable SubmitButtonMarginDef? get submitButtonMargin;@notSerializable OnDynamicInputDeletionDef? get onDynamicInputDeletion;@notSerializable OnSubmitErrorDef? get onSubmitError;/// The form's entire width won't exceed this value. Defaults to 512.
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,booleanFieldBuilder,dateTimeFieldBuilder,defaultPhoneCoutry,durationFieldBuilder,dynamicInputsNodeWidgetBuilder,formatDuration,formPageBuilder,generateId,headerBuilder,inputHeaderBuilder,inputsNodeExpanderBuilder,inputsNodeWidgetBuilder,mediaFieldBuilder,multiStepProgressIndicatorBuilder,numFieldBuilder,pickDate,pickDuration,pickTime,scoreBuilder,selectFieldBuilder,standardScaffoldBuilder,stringFieldBuilder,submitButtonBuilder,submitButtonMargin,onDynamicInputDeletion,onSubmitError,maxWidth,spacing,showAsteriskIfRequired]);

@override
String toString() {
  return 'WoFormThemeData(booleanFieldBuilder: $booleanFieldBuilder, dateTimeFieldBuilder: $dateTimeFieldBuilder, defaultPhoneCoutry: $defaultPhoneCoutry, durationFieldBuilder: $durationFieldBuilder, dynamicInputsNodeWidgetBuilder: $dynamicInputsNodeWidgetBuilder, formatDuration: $formatDuration, formPageBuilder: $formPageBuilder, generateId: $generateId, headerBuilder: $headerBuilder, inputHeaderBuilder: $inputHeaderBuilder, inputsNodeExpanderBuilder: $inputsNodeExpanderBuilder, inputsNodeWidgetBuilder: $inputsNodeWidgetBuilder, mediaFieldBuilder: $mediaFieldBuilder, multiStepProgressIndicatorBuilder: $multiStepProgressIndicatorBuilder, numFieldBuilder: $numFieldBuilder, pickDate: $pickDate, pickDuration: $pickDuration, pickTime: $pickTime, scoreBuilder: $scoreBuilder, selectFieldBuilder: $selectFieldBuilder, standardScaffoldBuilder: $standardScaffoldBuilder, stringFieldBuilder: $stringFieldBuilder, submitButtonBuilder: $submitButtonBuilder, submitButtonMargin: $submitButtonMargin, onDynamicInputDeletion: $onDynamicInputDeletion, onSubmitError: $onSubmitError, maxWidth: $maxWidth, spacing: $spacing, showAsteriskIfRequired: $showAsteriskIfRequired)';
}
...
/// Create a copy of WoFormThemeData
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? booleanFieldBuilder = freezed,Object? dateTimeFieldBuilder = freezed,Object? defaultPhoneCoutry = freezed,Object? durationFieldBuilder = freezed,Object? dynamicInputsNodeWidgetBuilder = freezed,Object? formatDuration = freezed,Object? formPageBuilder = freezed,Object? generateId = freezed,Object? headerBuilder = freezed,Object? inputHeaderBuilder = freezed,Object? inputsNodeExpanderBuilder = freezed,Object? inputsNodeWidgetBuilder = freezed,Object? mediaFieldBuilder = freezed,Object? multiStepProgressIndicatorBuilder = freezed,Object? numFieldBuilder = freezed,Object? pickDate = freezed,Object? pickDuration = freezed,Object? pickTime = freezed,Object? scoreBuilder = freezed,Object? selectFieldBuilder = freezed,Object? standardScaffoldBuilder = freezed,Object? stringFieldBuilder = freezed,Object? submitButtonBuilder = freezed,Object? submitButtonMargin = freezed,Object? onDynamicInputDeletion = freezed,Object? onSubmitError = freezed,Object? maxWidth = freezed,Object? spacing = freezed,Object? showAsteriskIfRequired = freezed,}) {
...
as DurationFieldBuilderDef?,dynamicInputsNodeWidgetBuilder: freezed == dynamicInputsNodeWidgetBuilder ? _self.dynamicInputsNodeWidgetBuilder : dynamicInputsNodeWidgetBuilder // ignore: cast_nullable_to_non_nullable
...
as PickTimeDef?,scoreBuilder: freezed == scoreBuilder ? _self.scoreBuilder : scoreBuilder // ignore: cast_nullable_to_non_nullable
...
as StringFieldBuilderDef?,submitButtonBuilder: freezed == submitButtonBuilder ? _self.submitButtonBuilder : submitButtonBuilder // ignore: cast_nullable_to_non_nullable
...
as SubmitButtonMarginDef?,onDynamicInputDeletion: freezed == onDynamicInputDeletion ? _self.onDynamicInputDeletion : onDynamicInputDeletion // ignore: cast_nullable_to_non_nullable

...
@notSerializable InputNodeWidgetBuilderDef? get inputsNodeExpanderBuilder;@notSerializable InputNodeWidgetBuilderDef? get inputsNodeWidgetBuilder;@notSerializable MediaFieldBuilderDef? get mediaFieldBuilder;@notSerializable MultiStepProgressIndicatorBuilderDef? get multiStepProgressIndicatorBuilder;@notSerializable NumFieldBuilderDef? get numFieldBuilder;@notSerializable PickDateDef? get pickDate; PickDateUiSettings? get pickDateUiSettings;@notSerializable PickDurationDef? get pickDuration;@notSerializable PickTimeDef? get pickTime;/// If this is set and returns null, there won't be a quit button.
@notSerializable QuitButtonBuilderDef? get quitButtonBuilder;/// Called when the user starts to reorder a reorderable list
/// (like in DynamicInputsNode). Intended for haptic feedback.
@notSerializable VoidCallback? get reorderFeedback;@notSerializable ScoreWidgetBuilderDef? get scoreBuilder;@notSerializable SelectFieldBuilderDef<dynamic>? get selectFieldBuilder;@notSerializable ScaffoldBuilderDef? get standardScaffoldBuilder;@notSerializable StringFieldBuilderDef? get stringFieldBuilder;@notSerializable CounterBuilderDef? get stringFieldCounterBuilder; FieldElementLocation? get stringFieldErrorLocation; FieldElementLocation? get stringFieldHelperLocation; FieldElementLocation? get stringFieldLabelLocation; FieldElementLocation? get stringFieldPrefixIconLocation;@notSerializable SubmitButtonBuilderDef? get submitButtonBuilder;/// Default values :
...
as PickDateUiSettings?,pickDuration: freezed == pickDuration ? _self.pickDuration : pickDuration // ignore: cast_nullable_to_non_nullable
...
as QuitButtonBuilderDef?,reorderFeedback: freezed == reorderFeedback ? _self.reorderFeedback : reorderFeedback // ignore: cast_nullable_to_non_nullable
as VoidCallback?,scoreBuilder: freezed == scoreBuilder ? _self.scoreBuilder : scoreBuilder // ignore: cast_nullable_to_non_nullable
...
as StringFieldBuilderDef?,stringFieldCounterBuilder: freezed == stringFieldCounterBuilder ? _self.stringFieldCounterBuilder : stringFieldCounterBuilder // ignore: cast_nullable_to_non_nullable
as CounterBuilderDef?,stringFieldErrorLocation: freezed == stringFieldErrorLocation ? _self.stringFieldErrorLocation : stringFieldErrorLocation // ignore: cast_nullable_to_non_nullable
as FieldElementLocation?,stringFieldHelperLocation: freezed == stringFieldHelperLocation ? _self.stringFieldHelperLocation : stringFieldHelperLocation // ignore: cast_nullable_to_non_nullable
as FieldElementLocation?,stringFieldLabelLocation: freezed == stringFieldLabelLocation ? _self.stringFieldLabelLocation : stringFieldLabelLocation // ignore: cast_nullable_to_non_nullable
as FieldElementLocation?,stringFieldPrefixIconLocation: freezed == stringFieldPrefixIconLocation ? _self.stringFieldPrefixIconLocation : stringFieldPrefixIconLocation // ignore: cast_nullable_to_non_nullable
as FieldElementLocation?,submitButtonBuilder: freezed == submitButtonBuilder ? _self.submitButtonBuilder : submitButtonBuilder // ignore: cast_nullable_to_non_nullable
...
/// (like in DynamicInputsNode). Intended for haptic feedback.
@override@notSerializable final  VoidCallback? reorderFeedback;
...
@override@notSerializable final  CounterBuilderDef? stringFieldCounterBuilder;
@override final  FieldElementLocation? stringFieldErrorLocation;
@override final  FieldElementLocation? stringFieldHelperLocation;
@override final  FieldElementLocation? stringFieldLabelLocation;
@override final  FieldElementLocation? stringFieldPrefixIconLocation;
...
@override $PickDateUiSettingsCopyWith<$Res>? get pickDateUiSettings;

...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,booleanFieldBuilder,dateTimeFieldBuilder,defaultPhoneCoutry,durationFieldBuilder,dynamicInputsNodeWidgetBuilder,formatDuration,formPageBuilder,generateId,headerBuilder,inputHeaderBuilder,inputsNodeExpanderBuilder,inputsNodeWidgetBuilder,mediaFieldBuilder,multiStepProgressIndicatorBuilder,numFieldBuilder,pickDate,pickDuration,pickTime,quitButtonBuilder,scoreBuilder,selectFieldBuilder,standardScaffoldBuilder,stringFieldBuilder,submitButtonBuilder,submitButtonMargin,submitButtonStyle,onDynamicInputDeletion,onSubmitError,maxWidth,spacing,showAsteriskIfRequired]);

...
class StringInput<T extends Object?> extends WoFormInput<T> {
  const StringInput({required this.id, this.initialValue, this.isRequired = false, this.regexPattern, this.maxLength, @notSerializable this.suggestionsSettings, @notSerializable this.getCustomError, this.uiSettings, @notSerializable this.getController, final  String? $type}): $type = $type ?? 'string',super._();
...
@notSerializable final  GetTextEditingControllerDef? getController;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is StringInput<T>&&(identical(other.id, id) || other.id == id)&&(identical(other.initialValue, initialValue) || other.initialValue == initialValue)&&(identical(other.isRequired, isRequired) || other.isRequired == isRequired)&&(identical(other.regexPattern, regexPattern) || other.regexPattern == regexPattern)&&(identical(other.maxLength, maxLength) || other.maxLength == maxLength)&&(identical(other.suggestionsSettings, suggestionsSettings) || other.suggestionsSettings == suggestionsSettings)&&(identical(other.getCustomError, getCustomError) || other.getCustomError == getCustomError)&&(identical(other.uiSettings, uiSettings) || other.uiSettings == uiSettings)&&(identical(other.getController, getController) || other.getController == getController));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,initialValue,isRequired,regexPattern,maxLength,suggestionsSettings,getCustomError,uiSettings,getController);

@override
String toString() {
  return 'WoFormInput<$T>.string(id: $id, initialValue: $initialValue, isRequired: $isRequired, regexPattern: $regexPattern, maxLength: $maxLength, suggestionsSettings: $suggestionsSettings, getCustomError: $getCustomError, uiSettings: $uiSettings, getController: $getController)';
}
...
@override @useResult
$Res call({
 String id, String? initialValue, bool isRequired, String? regexPattern, int? maxLength,@notSerializable SuggestionsSettings<T>? suggestionsSettings,@notSerializable GetCustomErrorDef<String>? getCustomError, StringInputUiSettings<T>? uiSettings,@notSerializable GetTextEditingControllerDef? getController
});


$SuggestionsSettingsCopyWith<T, $Res>? get suggestionsSettings;$StringInputUiSettingsCopyWith<T, $Res>? get uiSettings;
...
/// Create a copy of WoFormInput
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? initialValue = freezed,Object? isRequired = null,Object? regexPattern = freezed,Object? maxLength = freezed,Object? suggestionsSettings = freezed,Object? getCustomError = freezed,Object? uiSettings = freezed,Object? getController = freezed,}) {
...
as StringInputUiSettings<T>?,getController: freezed == getController ? _self.getController : getController // ignore: cast_nullable_to_non_nullable
as GetTextEditingControllerDef?,
  ));
}
...
@override
@pragma('vm:prefer-inline')
$SuggestionsSettingsCopyWith<T, $Res>? get suggestionsSettings {
    if (_self.suggestionsSettings == null) {
    return null;
  }

  return $SuggestionsSettingsCopyWith<T, $Res>(_self.suggestionsSettings!, (value) {
    return _then(_self.copyWith(suggestionsSettings: value));
  });
}/// Create a copy of WoFormInput
/// with the given fields replaced by the non-null parameter values.
@override
@pragma('vm:prefer-inline')
$StringInputUiSettingsCopyWith<T, $Res>? get uiSettings {
    if (_self.uiSettings == null) {
    return null;
  }

  return $StringInputUiSettingsCopyWith<T, $Res>(_self.uiSettings!, (value) {
    return _then(_self.copyWith(uiSettings: value));
  });
}
}
...
@notSerializable void Function(List<T>? value)? get onValueChanged;@notSerializable GetCustomErrorForListDef<T>? get getCustomError;/// Only applies if maxCount is 1
 bool get submitFormOnSelect; QuizSettings? get quizSettings; SearchSettings<T>? get searchSettings; SelectInputUiSettings<T>? get uiSettings;/// The following fields are mostly usefull for hydrataion
///
/// Ex :
...
$QuizSettingsCopyWith<$Res>? get quizSettings;$SearchSettingsCopyWith<T, $Res>? get searchSettings;$SelectInputUiSettingsCopyWith<T, $Res>? get uiSettings;
...
as bool,quizSettings: freezed == quizSettings ? _self.quizSettings : quizSettings // ignore: cast_nullable_to_non_nullable
as QuizSettings?,searchSettings: freezed == searchSettings ? _self.searchSettings : searchSettings // ignore: cast_nullable_to_non_nullable
as SearchSettings<T>?,uiSettings: freezed == uiSettings ? _self.uiSettings : uiSettings // ignore: cast_nullable_to_non_nullable
as SelectInputUiSettings<T>?,toJsonT: freezed == toJsonT ? _self.toJsonT : toJsonT // ignore: cast_nullable_to_non_nullable
...
@override
@pragma('vm:prefer-inline')
$SearchSettingsCopyWith<T, $Res>? get searchSettings {
    if (_self.searchSettings == null) {
    return null;
  }

  return $SearchSettingsCopyWith<T, $Res>(_self.searchSettings!, (value) {
    return _then(_self.copyWith(searchSettings: value));
  });
}/// Create a copy of SelectInput
/// with the given fields replaced by the non-null parameter values.
@override
...
@override final  SearchSettings<T>? searchSettings;
...
@override $QuizSettingsCopyWith<$Res>? get quizSettings;@override $SearchSettingsCopyWith<T, $Res>? get searchSettings;@override $SelectInputUiSettingsCopyWith<T, $Res>? get uiSettings;

...
mixin _$WoFormInputError {
  ...
  $WoFormInputErrorCopyWith<WoFormInputError> get copyWith =>
      _$WoFormInputErrorCopyWithImpl<WoFormInputError>(
          this as WoFormInputError, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is WoFormInputError &&
...
abstract mixin class $WoFormInputErrorCopyWith<$Res> {
  factory $WoFormInputErrorCopyWith(
          WoFormInputError value, $Res Function(WoFormInputError) _then) =
      _$WoFormInputErrorCopyWithImpl;
  @useResult
...
class EmptyInputError implements WoFormInputError {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $EmptyInputErrorCopyWith<EmptyInputError> get copyWith =>
      _$EmptyInputErrorCopyWithImpl<EmptyInputError>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is EmptyInputError &&
            (identical(other.path, path) || other.path == path));
  }
...
/// @nodoc
abstract mixin class $EmptyInputErrorCopyWith<$Res>
    implements $WoFormInputErrorCopyWith<$Res> {
  factory $EmptyInputErrorCopyWith(
          EmptyInputError value, $Res Function(EmptyInputError) _then) =
      _$EmptyInputErrorCopyWithImpl;
  @override
  @useResult
  $Res call({String path});
}
...
class InvalidInputError implements WoFormInputError {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $InvalidInputErrorCopyWith<InvalidInputError> get copyWith =>
      _$InvalidInputErrorCopyWithImpl<InvalidInputError>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is InvalidInputError &&
            (identical(other.path, path) || other.path == path));
  }
...
/// @nodoc
abstract mixin class $InvalidInputErrorCopyWith<$Res>
    implements $WoFormInputErrorCopyWith<$Res> {
  factory $InvalidInputErrorCopyWith(
          InvalidInputError value, $Res Function(InvalidInputError) _then) =
      _$InvalidInputErrorCopyWithImpl;
  @override
  @useResult
  $Res call({String path});
}
...
class MaxBoundInputError implements WoFormInputError {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $MaxBoundInputErrorCopyWith<MaxBoundInputError> get copyWith =>
      _$MaxBoundInputErrorCopyWithImpl<MaxBoundInputError>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is MaxBoundInputError &&
            (identical(other.path, path) || other.path == path));
  }
...
/// @nodoc
abstract mixin class $MaxBoundInputErrorCopyWith<$Res>
    implements $WoFormInputErrorCopyWith<$Res> {
  factory $MaxBoundInputErrorCopyWith(
          MaxBoundInputError value, $Res Function(MaxBoundInputError) _then) =
      _$MaxBoundInputErrorCopyWithImpl;
  @override
  @useResult
  $Res call({String path});
}
...
class MinBoundInputError implements WoFormInputError {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $MinBoundInputErrorCopyWith<MinBoundInputError> get copyWith =>
      _$MinBoundInputErrorCopyWithImpl<MinBoundInputError>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is MinBoundInputError &&
            (identical(other.path, path) || other.path == path));
  }
...
/// @nodoc
abstract mixin class $MinBoundInputErrorCopyWith<$Res>
    implements $WoFormInputErrorCopyWith<$Res> {
  factory $MinBoundInputErrorCopyWith(
          MinBoundInputError value, $Res Function(MinBoundInputError) _then) =
      _$MinBoundInputErrorCopyWithImpl;
  @override
  @useResult
  $Res call({String path});
}
...
class CustomInputError implements WoFormInputError {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $CustomInputErrorCopyWith<CustomInputError> get copyWith =>
      _$CustomInputErrorCopyWithImpl<CustomInputError>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is CustomInputError &&
            (identical(other.path, path) || other.path == path) &&
...
/// @nodoc
abstract mixin class $CustomInputErrorCopyWith<$Res>
    implements $WoFormInputErrorCopyWith<$Res> {
  factory $CustomInputErrorCopyWith(
          CustomInputError value, $Res Function(CustomInputError) _then) =
      _$CustomInputErrorCopyWithImpl;
  @override
  @useResult
...
mixin _$WoFormInput {
  ...
  $WoFormInputCopyWith<WoFormInput> get copyWith =>
      _$WoFormInputCopyWithImpl<WoFormInput>(this as WoFormInput, _$identity);
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, getCustomError,
...
abstract mixin class $WoFormInputCopyWith<$Res> {
  factory $WoFormInputCopyWith(
          WoFormInput value, $Res Function(WoFormInput) _then) =
      _$WoFormInputCopyWithImpl;
  @useResult
  $Res call({String id});
}

/// @nodoc
class _$WoFormInputCopyWithImpl<$Res> implements $WoFormInputCopyWith<$Res> {
...
class BooleanInput extends WoFormInput {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $BooleanInputCopyWith<BooleanInput> get copyWith =>
      _$BooleanInputCopyWithImpl<BooleanInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$BooleanInputToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class $BooleanInputCopyWith<$Res>
    implements $WoFormInputCopyWith<$Res> {
  factory $BooleanInputCopyWith(
          BooleanInput value, $Res Function(BooleanInput) _then) =
      _$BooleanInputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class _$BooleanInputCopyWithImpl<$Res> implements $BooleanInputCopyWith<$Res> {
...
class DateTimeInput extends WoFormInput {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $DateTimeInputCopyWith<DateTimeInput> get copyWith =>
      _$DateTimeInputCopyWithImpl<DateTimeInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$DateTimeInputToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class $DateTimeInputCopyWith<$Res>
    implements $WoFormInputCopyWith<$Res> {
  factory $DateTimeInputCopyWith(
          DateTimeInput value, $Res Function(DateTimeInput) _then) =
      _$DateTimeInputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String id,
...
class DurationInput extends WoFormInput {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $DurationInputCopyWith<DurationInput> get copyWith =>
      _$DurationInputCopyWithImpl<DurationInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$DurationInputToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class $DurationInputCopyWith<$Res>
    implements $WoFormInputCopyWith<$Res> {
  factory $DurationInputCopyWith(
          DurationInput value, $Res Function(DurationInput) _then) =
      _$DurationInputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String id,
...
class MediaInput extends WoFormInput {
  ...
  /// An optionnal callback when the value changed
  @JsonKey(includeToJson: false, includeFromJson: false)
  final void Function(List<Media>? value)? onValueChanged;
  ...
  $MediaInputCopyWith<MediaInput> get copyWith =>
      _$MediaInputCopyWithImpl<MediaInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$MediaInputToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class $MediaInputCopyWith<$Res>
    implements $WoFormInputCopyWith<$Res> {
  factory $MediaInputCopyWith(
          MediaInput value, $Res Function(MediaInput) _then) =
      _$MediaInputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String id,
  ...
  $Res call({
    ...
    return _then(MediaInput(
      ...
      onValueChanged: freezed == onValueChanged
          ? _self.onValueChanged
          : onValueChanged // ignore: cast_nullable_to_non_nullable
              as void Function(List<Media>? value)?,
      submitFormOnSelect: null == submitFormOnSelect
          ? _self.submitFormOnSelect
...
class NumInput extends WoFormInput {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $NumInputCopyWith<NumInput> get copyWith =>
      _$NumInputCopyWithImpl<NumInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$NumInputToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class $NumInputCopyWith<$Res>
    implements $WoFormInputCopyWith<$Res> {
  factory $NumInputCopyWith(NumInput value, $Res Function(NumInput) _then) =
      _$NumInputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class _$NumInputCopyWithImpl<$Res> implements $NumInputCopyWith<$Res> {
...
class SelectStringInput extends WoFormInput {
  ...
  factory SelectStringInput.fromJson(Map<String, dynamic> json) =>
      _$SelectStringInputFromJson(json);
...
// will be the id of the selected value.
  ...
  /// An optionnal callback when the value changed
  @JsonKey(includeToJson: false, includeFromJson: false)
  final void Function(List<String>? value)? onValueChanged;
...
// The correct answer is the index of availibleValues
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $SelectStringInputCopyWith<SelectStringInput> get copyWith =>
      _$SelectStringInputCopyWithImpl<SelectStringInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$SelectStringInputToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class $SelectStringInputCopyWith<$Res>
    implements $WoFormInputCopyWith<$Res> {
  factory $SelectStringInputCopyWith(
          SelectStringInput value, $Res Function(SelectStringInput) _then) =
      _$SelectStringInputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String id,
...
class _$SelectStringInputCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(SelectStringInput(
      ...
      onValueChanged: freezed == onValueChanged
          ? _self.onValueChanged
          : onValueChanged // ignore: cast_nullable_to_non_nullable
              as void Function(List<String>? value)?,
      submitFormOnSelect: null == submitFormOnSelect
          ? _self.submitFormOnSelect
          : submitFormOnSelect // ignore: cast_nullable_to_non_nullable
              as bool,
  ...
  @pragma('vm:prefer-inline')
  $SelectInputUiSettingsCopyWith<String, $Res> get uiSettings {
    return $SelectInputUiSettingsCopyWith<String, $Res>(_self.uiSettings,
        (value) {
      return _then(_self.copyWith(uiSettings: value));
    });
  }
...
class StringInput extends WoFormInput {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $StringInputCopyWith<StringInput> get copyWith =>
      _$StringInputCopyWithImpl<StringInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$StringInputToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class $StringInputCopyWith<$Res>
    implements $WoFormInputCopyWith<$Res> {
  factory $StringInputCopyWith(
          StringInput value, $Res Function(StringInput) _then) =
      _$StringInputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class _$StringInputCopyWithImpl<$Res> implements $StringInputCopyWith<$Res> {
...
mixin _$SelectInput<T> {
  ...
  /// An optionnal callback when the value changed
  @JsonKey(includeToJson: false, includeFromJson: false)
  void Function(List<T>? value)? get onValueChanged;
  @JsonKey(includeToJson: false, includeFromJson: false)
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.availibleValues, availibleValues) &&
            const DeepCollectionEquality()
                .equals(other.idsOfAvailibleValues, idsOfAvailibleValues) &&
            (identical(other.onValueChanged, onValueChanged) ||
                other.onValueChanged == onValueChanged) &&
            (identical(other.getCustomError, getCustomError) ||
                other.getCustomError == getCustomError) &&
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(availibleValues),
      const DeepCollectionEquality().hash(idsOfAvailibleValues),
      onValueChanged,
      getCustomError,
      submitFormOnSelect,
      uiSettings,
...
abstract mixin class $SelectInputCopyWith<T, $Res> {
  factory $SelectInputCopyWith(
          SelectInput<T> value, $Res Function(SelectInput<T>) _then) =
      _$SelectInputCopyWithImpl;
  @useResult
  $Res call(
      {String id,
      int? maxCount,
    ...
    return _then(_self.copyWith(
      ...
      initialValues: freezed == initialValues
          ...
          : initialValues // ignore: cast_nullable_to_non_nullable
              as List<T>?,
      availibleValues: null == availibleValues
          ? _self.availibleValues
          : availibleValues // ignore: cast_nullable_to_non_nullable
              as List<T>,
      idsOfAvailibleValues: freezed == idsOfAvailibleValues
          ? _self.idsOfAvailibleValues
          : idsOfAvailibleValues // ignore: cast_nullable_to_non_nullable
              as List<String>?,
      onValueChanged: freezed == onValueChanged
          ? _self.onValueChanged
          : onValueChanged // ignore: cast_nullable_to_non_nullable
              as void Function(List<T>? value)?,
      getCustomError: freezed == getCustomError
          ? _self.getCustomError
          : getCustomError // ignore: cast_nullable_to_non_nullable
...
/// @nodoc
abstract mixin class _$SelectInputCopyWith<T, $Res>
    implements $SelectInputCopyWith<T, $Res> {
  factory _$SelectInputCopyWith(
          _SelectInput<T> value, $Res Function(_SelectInput<T>) _then) =
      __$SelectInputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String id,

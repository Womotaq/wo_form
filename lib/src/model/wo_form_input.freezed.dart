...
mixin _$WoFormInput {
 ...
 String get id;@notSerializable WoFormInputError? Function(Never, String)? get getCustomError;@JsonKey(toJson: _SelectInputUiSettingsX.staticToJsonString) Object get uiSettings;
...
class BooleanInput extends WoFormInput {
  const BooleanInput({required this.id, this.initialValue, this.isRequired = false, @notSerializable this.getCustomError, @notSerializable this.onValueChanged, this.uiSettings = const BooleanInputUiSettings(), final  String? $type}): $type = $type ?? 'boolean',super._();
...
@override@JsonKey() final  BooleanInputUiSettings uiSettings;
...
class DateTimeInput extends WoFormInput {
  const DateTimeInput({required this.id, this.initialValue, this.isRequired = false, this.maxDate, this.minDate, @notSerializable this.getCustomError, this.uiSettings = const DateTimeInputUiSettings(), final  String? $type}): $type = $type ?? 'dateTime',super._();
...
@override@JsonKey() final  DateTimeInputUiSettings uiSettings;
...
@override@JsonKey() final  DurationInputUiSettings uiSettings;
...
@override@JsonKey() final  MediaInputUiSettings uiSettings;
...
@override @useResult
$Res call({
 String id, int? maxCount, int minCount, List<String>? initialValues, List<String> availibleValues, List<String>? idsOfAvailibleValues,@notSerializable GetCustomErrorForListDef<String>? getCustomError,@notSerializable void Function(List<String>? value)? onValueChanged, bool submitFormOnSelect,@JsonKey(toJson: _SelectInputUiSettingsX.staticToJsonString) SelectInputUiSettings<String> uiSettings, QuizSettings? quizSettings
});

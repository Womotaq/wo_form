...
// Contains an array of predictions.
  ...
  PlacesAutocompleteStatus
      get status; // When the service returns a status code other than OK, there may be an
...
// subject to change.
  ...
  $PlacesAutocompleteResponseCopyWith<PlacesAutocompleteResponse>
      get copyWith =>
          _$PlacesAutocompleteResponseCopyWithImpl<PlacesAutocompleteResponse>(
              this as PlacesAutocompleteResponse, _$identity);
...
abstract mixin class $PlacesAutocompleteResponseCopyWith<$Res> {
  factory $PlacesAutocompleteResponseCopyWith(PlacesAutocompleteResponse value,
          $Res Function(PlacesAutocompleteResponse) _then) =
      _$PlacesAutocompleteResponseCopyWithImpl;
  @useResult
  $Res call(
...
// subject to change.
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$PlacesAutocompleteResponseCopyWith<_PlacesAutocompleteResponse>
      get copyWith => __$PlacesAutocompleteResponseCopyWithImpl<
          _PlacesAutocompleteResponse>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$PlacesAutocompleteResponseToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _PlacesAutocompleteResponse &&
            const DeepCollectionEquality()
...
/// @nodoc
abstract mixin class _$PlacesAutocompleteResponseCopyWith<$Res>
    implements $PlacesAutocompleteResponseCopyWith<$Res> {
  factory _$PlacesAutocompleteResponseCopyWith(
          _PlacesAutocompleteResponse value,
          $Res Function(_PlacesAutocompleteResponse) _then) =
      __$PlacesAutocompleteResponseCopyWithImpl;
  @override
  @useResult
  $Res call(
      {List<PlacePrediction> predictions,
...
mixin _$PlacePrediction {
  ...
  $PlacePredictionCopyWith<PlacePrediction> get copyWith =>
      _$PlacePredictionCopyWithImpl<PlacePrediction>(
          this as PlacePrediction, _$identity);
...
abstract mixin class $PlacePredictionCopyWith<$Res> {
  factory $PlacePredictionCopyWith(
          PlacePrediction value, $Res Function(PlacePrediction) _then) =
      _$PlacePredictionCopyWithImpl;
  @useResult
  $Res call(
      {String description,
      @JsonKey(name: 'matched_substrings')
...
class _$PlacePredictionCopyWithImpl<$Res>
  ...
  @pragma('vm:prefer-inline')
  $StructuredFormattingCopyWith<$Res> get structuredFormatting {
    return $StructuredFormattingCopyWith<$Res>(_self.structuredFormatting,
        (value) {
...
class _PlacePrediction extends PlacePrediction {
  const _PlacePrediction(
      ...
      @JsonKey(name: 'matched_substrings')
      required final List<MatchedSubstrings> matchedSubstrings,
      @JsonKey(name: 'structured_formatting')
  ...
  @override
  Map<String, dynamic> toJson() {
    return _$PlacePredictionToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$PlacePredictionCopyWith<$Res>
    implements $PlacePredictionCopyWith<$Res> {
  factory _$PlacePredictionCopyWith(
          _PlacePrediction value, $Res Function(_PlacePrediction) _then) =
...
mixin _$MatchedSubstrings {
  ...
  $MatchedSubstringsCopyWith<MatchedSubstrings> get copyWith =>
      _$MatchedSubstringsCopyWithImpl<MatchedSubstrings>(
          this as MatchedSubstrings, _$identity);
...
class _MatchedSubstrings extends MatchedSubstrings {
  ...
  @override
  Map<String, dynamic> toJson() {
    return _$MatchedSubstringsToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$MatchedSubstringsCopyWith<$Res>
    implements $MatchedSubstringsCopyWith<$Res> {
  factory _$MatchedSubstringsCopyWith(
          _MatchedSubstrings value, $Res Function(_MatchedSubstrings) _then) =
...
// Contains the main text of a prediction, usually the name of the place.
  ...
  String
      get mainText; // Contains an array with offset value and length. These describe the
...
// the term can be highlighted if desired.
  ...
  List<MatchedSubstrings> get mainTextMatchedSubstrings;

  /// Contains the secondary text of a prediction, usually the location of
  /// the place.
  @JsonKey(name: 'secondary_text')
  String?
      get secondaryText; // Contains an array with offset value and length. These describe the
// location of the entered term in the prediction result text, so that
//the term can be highlighted if desired.
  @JsonKey(name: 'secondary_text_matched_substrings')
  List<MatchedSubstrings>? get secondaryTextMatchedSubstrings;
  ...
  $StructuredFormattingCopyWith<StructuredFormatting> get copyWith =>
      _$StructuredFormattingCopyWithImpl<StructuredFormatting>(
          this as StructuredFormatting, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(
                other.secondaryTextMatchedSubstrings,
  ...
  int get hashCode => Object.hash(
      ...
      secondaryText,
      const DeepCollectionEquality().hash(secondaryTextMatchedSubstrings));
...
abstract mixin class $StructuredFormattingCopyWith<$Res> {
  factory $StructuredFormattingCopyWith(StructuredFormatting value,
          $Res Function(StructuredFormatting) _then) =
      _$StructuredFormattingCopyWithImpl;
  @useResult
  $Res call(
  ...
  $Res call({
    ...
    return _then(_self.copyWith(
      ...
      mainTextMatchedSubstrings: null == mainTextMatchedSubstrings
          ? _self.mainTextMatchedSubstrings
      ...
      secondaryTextMatchedSubstrings: freezed == secondaryTextMatchedSubstrings
          ? _self.secondaryTextMatchedSubstrings
...
class _StructuredFormatting extends StructuredFormatting {
  const _StructuredFormatting(
      ...
      @JsonKey(name: 'main_text_matched_substrings')
      required final List<MatchedSubstrings> mainTextMatchedSubstrings,
...
//the term can be highlighted if desired.
  ...
  @override
  Map<String, dynamic> toJson() {
    return _$StructuredFormattingToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$StructuredFormattingCopyWith<$Res>
    implements $StructuredFormattingCopyWith<$Res> {
  factory _$StructuredFormattingCopyWith(_StructuredFormatting value,
          $Res Function(_StructuredFormatting) _then) =
    ...
    return _then(_StructuredFormatting(
      mainText: null == mainText
          ...
          : mainText // ignore: cast_nullable_to_non_nullable
              as String,
      mainTextMatchedSubstrings: null == mainTextMatchedSubstrings
          ? _self._mainTextMatchedSubstrings
          : mainTextMatchedSubstrings // ignore: cast_nullable_to_non_nullable
              as List<MatchedSubstrings>,
      secondaryText: freezed == secondaryText
          ? _self.secondaryText
          : secondaryText // ignore: cast_nullable_to_non_nullable
              as String?,
      secondaryTextMatchedSubstrings: freezed == secondaryTextMatchedSubstrings
          ? _self._secondaryTextMatchedSubstrings
          : secondaryTextMatchedSubstrings // ignore: cast_nullable_to_non_nullable
              as List<MatchedSubstrings>?,
    ));
  }
...
// measured in Unicode characters.
  ...
  $TermCopyWith<Term> get copyWith =>
      _$TermCopyWithImpl<Term>(this as Term, _$identity);
...
abstract mixin class _$TermCopyWith<$Res> implements $TermCopyWith<$Res> {
  factory _$TermCopyWith(_Term value, $Res Function(_Term) _then) =
      __$TermCopyWithImpl;
  @override
  @useResult
  $Res call({int offset, String value});
...
/// @nodoc
class __$TermCopyWithImpl<$Res> implements _$TermCopyWith<$Res> {
